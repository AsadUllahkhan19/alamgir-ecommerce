...
const JuniorJeans = (props) => {
  ...
  const _handleCart = (e) =>{
    ...
    axios.get("https://alummat.herokuapp.com/products/juniorjeans/"+e.target.id).then((res)=>{
...
export default connect(mapStateToProps,mapDispatchToProps)(JuniorJeans);
